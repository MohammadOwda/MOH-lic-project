...
<head>
<meta charset="utf-8"/>
<title>نظام الاجازة و التراخيص</title>
...
<!-- BEGIN THEME STYLES -->
<link href="{{ asset('global/css/components-rtl.css')}}" id="style_components" rel="stylesheet" type="text/css"/>
<link href="{{ asset('global/css/plugins-rtl.css')}}" rel="stylesheet" type="text/css"/>
<link href="{{ asset('admin/layout/css/layout-rtl.css')}}" rel="stylesheet" type="text/css"/>
<link id="style_color" href="{{ asset('admin/layout/css/themes/default-rtl.css')}}" rel="stylesheet" type="text/css"/>
<link href="{{ asset('admin/layout/css/custom-rtl.css')}}" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			...
			<div class="logo-caption">
                            <span style="display: inline-block">دولة فلسطين</span><br>
                            <span style="display: inline-block">وزارة الصحة الفلسطينية</span>
                        </div>
			</a>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="active open">
					...
					<span class="title">نظام الاجازة والتراخيص</span>
					...
					<ul class="sub-menu">
						...
						<li>
							<a href="javascript:;">
							<i class="icon-settings"></i> الثوابت <span class="arrow"></span>
							</a>
							<ul class="sub-menu">
								<li>
